...
- Added support for chronological model execution batching
...
- Exposed access to the Redis.AI MINBATCHTIMEOUT parameter, which adds a brief delay to model execution in order to try to accumulate multiple executions in a batch (PR407_)
